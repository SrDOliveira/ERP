...
SECRET_KEY = 'django-insecure-jw&i0t_dxhael@4isr+fqtgdhcy#*n#qq9mx8$2$d4haaoiylm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'] # Deixe assim por enquanto, depois colocamos o domínio exato

# Garanta que esta linha está lá para o banco de dados:
import dj_database_url
DATABASES = {
...
INSTALLED_APPS = [
    ...
    'core',  # <--- Tem que ter as aspas e a vírgula!
]

# Esta linha deve ficar FORA da lista, pode ser logo abaixo dela
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.notificacoes_estoque', # <--- ADICIONE AQUI
            ],
        },
    },
]
...
# --- CONFIGURAÇÕES DE UPLOAD DE ARQUIVOS (IMAGENS, PDFS, ETC) ---
